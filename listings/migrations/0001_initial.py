# Generated by Django 4.2.2 on 2023-07-13 19:08
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            name='Property',
            fields=[
                ('id', shortuuid.django_fields.ShortUUIDField(alphabet='abcdefg123456', length=12, max_length=40, prefix='spc', primary_key=True, serialize=False)),
                ('name', models.CharField(max_length=100, verbose_name='Property Name')),
                ('description', models.TextField(verbose_name='About Your Property')),
                ('property_type', models.CharField(choices=[('deluxe_houses', 'Deluxe Houses'), ('bungalow', 'Bungalow'), ('modern_flats', 'Modern Flats'), ('apartments', 'Apartments'), ('industrial', 'Industrial'), ('condos', 'Condos'), ('offices', 'Offices'), ('retails ', 'Retails'), ('villas', 'Villas'), ('shop', 'Shop')], max_length=20)),
                ('photo', models.ImageField(default='default_image.jpg', upload_to='property_images/', verbose_name='Add Property Image')),
                ...
                ('total_area', models.DecimalField(blank=True, decimal_places=2, max_digits=8)),
                ('status', models.CharField(choices=[('sale', 'For Sale'), ('rent', 'For Rent')], max_length=4)),
                ('is_featured', models.BooleanField(default=False)),
                ('video_url', models.URLField(blank=True, verbose_name='Property Video Link')),
                ('publish', models.CharField(choices=[('draft', 'Draft'), ('published', 'Published')], default='draft', max_length=20)),
                ('created_date', models.DateTimeField(auto_now=True)),
                ('features', models.OneToOneField(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='listings.feature')),
                ('location', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='listings.location')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('contact_number', models.CharField(blank=True, max_length=50, null=True, verbose_name='Phone Number')),
